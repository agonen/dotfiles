...
gls_fleet_paths(){
	echo video    : gs://brodmann_internal/datasources/datasource=fleet/stage=raw/datatype=video/setup=${1}/video=${1}/clip=na/\*
	echo car_info : gs://brodmann_internal/datasources/datasource=fleet/stage=raw/datatype=fleet_capture_info/setup=${1}/video=${1}/clip=na/\*
	echo stat : gs://brodmann_internal/datasources/datasource=fleet/stage=raw/datatype=fleet_frames_stat/setup=${1}/video=${1}/clip=na/\*
